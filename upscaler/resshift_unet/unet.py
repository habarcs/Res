...
from upscaler.resshift_unet.basic_ops import (
    linear,
    conv_nd,
    avg_pool_nd,
    zero_module,
...
from upscaler.resshift_unet.swin_transformer import BasicLayer
...
class UNetModelSwin(nn.Module):
    ...
    def __init__(
        ...
        if cond_lq and lq_size == image_size:
            ...
            base_chn = 16
            for _ in range(int(math.log(lq_size / image_size) / math.log(2))):
